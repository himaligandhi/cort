     ...
     <div id="services" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                <h1 style="color:#8B040B;"><u>Lending Solutions</u>
            </h1>
                <p style="margin-top:50px;">
                <span style="color:#8B040B;">COR</span>Financial Corp understands the cash-flow pressures that small to mid-sized businesses face every day. With our depth of resources, we not only provide funding solutions but also provide a hands-on approach which helps alleviate some of the stress associated with funding. We don’t just provide approvals and then move on to other clients, we will provide our expertise and knowledge after funding and assist our clients throughout the initial loan period into a transition period to prepare them for the opportunity to apply to the conventional bank for more appealing rates and terms. Although our sweet spot is loans of $100,000 to $5,000,000 we have the capability to syndicate larger loans up to $15,000,000 and possibly higher. Credit is not a major factor in determining an approval; we provide practical, flexible & creative solutions to each client based on assets, enterprise value & borrowing needs. Here are the funding solutions that we can provide.
            ...
            <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="services-inner-box">
                        ...
                        <h2>Commerical Real Estate Financing</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="services-inner-box">
                        ...
                        <h2>Automotive Lease Financing</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="services-inner-box">
                        ...
                        <h2>Marijauna Grow Op Financing</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
