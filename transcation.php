...
<body>
   ...
   <a class="navbar-brand js-scroll-trigger" href="about.php">
            ...
            <h3 style="color:black;margin-left:25px;">COMMERCIAL RESTRUCTURING SPECIALISTS</h3>
...
<nav class="navbar navbar-expand-sm navbar-dark" style="margin-bottom: 15px;">
   <div class="container-fluid" style="border-top:0.5px solid #44444C; border-bottom: 0.5px solid #44444C;">
    ...
    <div class="transactions">
        <div class="container">
            <div class="section-title text-center">
                <h1 style="color:#8B040B;"><u>Transactions</u></h1>

            </div><!-- end title -->

            <div class="row" style="margin-top: 150px;" >
            <div class="col-md-3" >
                    <div class="trans-inner-box" >

                        <h2><strong>Power of Sale Purchase</strong></h2>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$6,200,000</h4>
                        <p>Structured the sale of a property in Power of Sale to a large development company.</p>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <p>March 2020</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3" >
                    <div class="trans-inner-box" >
                        ...
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$11,200,000</h4>
                        <p>Faciliy for multinational operations company</p>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <p>July 2019</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        ...
                        <h2><strong>Automotive Securitization Loan</strong></h2>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$12,000,000</h4>
                        <p>Structured and Syndicated Securitization Facility for Automotive Leasing Company </p>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <p>June 2019</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        ...
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$5,300,000</h4>
                        <p>Bridge Loan for Entertainment Centre </p>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <p>May 2019</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        ...
                        <h2><strong>Consolidation and Refinancing Facility</strong></h2>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$25,300,000</h4>
                        <p>Consolidation of Operating Facilities Including Additional Working Capital for a Multi National Holding Company </p>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <p>April 2019</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        ...
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$8,500,000</h4>
                        <p>To Facilitate Leasehold Improvements and Working Capital </p>
                ...
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        ...
                        <h2><strong>Commercial Purchase</strong></h2>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$1,350,000</h4>
                        <p>1st Mortgage on a 12,000 sq. ft Commercial Building in Stoney Creek, ON </p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        <h2>
                            <strong>
                                Pre-eminent Night Club & Recording Studio
                            </strong>
                        </h2>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$6,300,000</h4>
                        <p>Bridge Loan Pending Long Term Funding</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        <h2><strong>Food Importer</strong></h2>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$750,000</h4>
                        <p>Letter of Credit Provided to Supplier</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        ...
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$250,000</h4>
                        <p>Revolving Facility</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        <h2><strong>Non-Prime Leasing Company</strong></h2>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$1,500,000</h4>
                        <p>Funds Provided to Refinance and Grow Lease Portfolio</p>
                    </div>
                </div><!-- end col -->
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        <h2><strong>Used Car Dealer</strong></h2>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$2,000,000</h4>
                        <p>Inventory Line</p>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="trans-inner-box">
                        <h2><strong>Consumer Products Distributor</strong></h2>
                        <hr style="width:80px; height:3px; background-color:orangered; margin-top:0px; border-radius:5px;" />
                        <h4>$250,000</h4>
                        <p>Revolving Facility</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="footer-widget">
                            ...
                            <p style="color:white; font-size:1em; margin-bottom:5px;"><i class="fa fa-mobile" aria-hidden="true"></i> &nbsp (416)5462859</p>    
                            <p style="color:white; font-size:1em; margin-bottom:5px;"><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:someone@example.com?Subject=Inquired%20Financial%20Solutions" style="color:white;">info@corfinancialcorp.com</a></p>
                            <p style="color:white; font-size:1.5em;"><strong>Stay Connected !!</strong></p>
                       
                            <ul class="social-icons">
                            <li style="width:50px;"><a class="facebook" href="https://www.facebook.com/CORFinancial-Corp-118192885553051/"><i class="fa fa-facebook facebook-bg"></i></a></li>
                            <li style="width:50px;"><a class="instagram" href="https://www.instagram.com/cor_financial/"><i class="fa fa-instagram"></i></a></li>
                            <!--<li><a class="dribbble" href="#"><i class="fa fa-dribbble"></i></a></li>-->
                            <li style="width:100px;"><a class="linkedin" href="https://www.linkedin.com/company/corfinancialcorp/"><i class="fa fa-linkedin"></i></a></li>
                        </ul>
